...
public class GraphSummaryUtils {
    ...
    public static Map<Integer, Summary> getAntNaboerTilSummary(Map<Integer, Map<Integer, Integer>> graph,
            int antallNaboerHverVei) {

        final List<Map.Entry<Integer, Map<Integer, Integer>>> entries = graph.entrySet().stream()
    ...
    public static final Function<Map.Entry<Integer, Map<Integer, Integer>>, Summary> summaryMultigraphMapper = (
            entry) -> {
